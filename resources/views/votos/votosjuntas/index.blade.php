...
<div class="row">
	...
	<!--	<h3>Votos x Junta <a href="/personas/candidatos/create"><button class="btn btn-success">Nuevo</button></a> </h3>-->
		...
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-condensed table-hover">
				...
				<tr>
					...
					<td>{{$can->lugar}}</td>
					<td>
						<a href="{{URL::action('VotosJuntaController@show',$can->idcandidato)}}"><button class="btn btn-info" >Ingresar Votos</button></a>
